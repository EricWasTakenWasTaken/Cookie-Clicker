...
BlackholeInverter.launch = function(){
	BlackholeInverter.init = function(){
		...
		CCSE.NewBuilding('Black hole inverter',
			...
			1,
			{
				base:'https://ericwastakenwastaken.github.io/Cookie-Clicker/img/UniversalDecompressorBuilding.png',
				xV:8,
				yV:32,
				w:128,
				rows:1,
				x:0,
				y:0,
				customBuildingPic:'https://ericwastakenwastaken.github.io/Cookie-Clicker/img/customBuildings.png',
